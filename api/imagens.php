...
<ul>
    <?php foreach($arquivos as $arquivo): // pecorrer o array com os arquivos?>
        <?php if(stripos($arquivo, '.png') > 0): // filtrar somente os arquivos .png  e abaixo carrega o arquivo .png na tela?>
            <li>
